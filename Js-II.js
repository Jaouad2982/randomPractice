...
Please submit your work as soon as you have completed the assignment. If you don't finish all of the assignment, that's okay! We do want to see what you came up with by 8:45am 
...
for(let j = 0 ; j < adjectiveArray.length ; j ++){
    if(i == j){
      console.log(nameArray[i] + " is " + adjectiveArray[j]);
    }
  }
}
...
1.
the slahes are escapes characters. you are  telling the compiler to ignore that quote and add it 
by adding \'. there are so many such as \t or \n ....

2.
newline from console
3.
